# Código corrigido — `lista_dupla.java`

O erro acontecia nesta linha:

```java
int n = sc.nextInt();
```

Porque o programa tentava ler um número que não existia mais na entrada.
...
public class lista_dupla {
    ...
    static class Restaurante {
        ...
        public Restaurante(int id, String nome, String cidade, int capacidade,
                double avaliacao, String[] tiposCozinha,
                int faixaPreco, Hora horarioAbertura,
                Hora horarioFechamento, Data dataAbertura,
                boolean aberto) {
        ...
        public static Restaurante parseRestaurante(String s) {
            ...
            for (int i = 0; i < campos[6].length(); i++)
                if (campos[6].charAt(i) == '$')
                    faixaPreco++;

            int dashIdx = -1;

            for (int i = 0; i < campos[7].length(); i++) {
                if (campos[7].charAt(i) == '-') {
                    dashIdx = i;
                    break;
                }
            }
            ...
            for (int i = 0; i < campos[7].length(); i++) {
                if (i < dashIdx)
                    horAb.append(campos[7].charAt(i));
                else if (i > dashIdx)
                    horFech.append(campos[7].charAt(i));
            }
            ...
            return new Restaurante(
                    ...
                    tiposCozinha,
                    faixaPreco,
                    Hora.parseHora(horAb.toString()),
                    Hora.parseHora(horFech.toString()),
                    dataAbertura,
                    aberto);
        }
        ...
        public String formatar() {
            ...
            sb.append('[')
              ...
              .append(capacidade)
              .append(" ## ")
              .append(String.format("%.1f", avaliacao))
              .append(" ## [");
            ...
            sb.append(" ## ")
              .append(horarioAbertura.formatar())
              .append('-')
              .append(horarioFechamento.formatar())
              .append(" ## ")
              .append(dataAbertura.formatar())
              .append(" ## ")
              .append(aberto)
              .append(']');
        ...
        for (int k = 0; k < n; k++) {
            ...
            if (cmd.charAt(0) == 'I') {
                ...
                if (cmd.length() > 1 && cmd.charAt(1) == 'I')
                    ...
                    r = lista.remover(lerInt(tokens[1]));
...
sem verificar se realmente existia outro número na entrada.

Quando não existia, acontecia:
...
Assim o programa não tenta ler dados inexistentes.
